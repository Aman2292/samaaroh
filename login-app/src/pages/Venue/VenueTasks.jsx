...
import { Add, Calendar, User, Clock, Flag, TickCircle } from 'iconsax-react';
import { toast } from 'react-toastify';
import TaskModal from '../../components/Tasks/TaskModal';

const VenueTasks = ({ venueData, onUpdate }) => {
            ...
            <div className="flex justify-between items-center mb-6">
                <div>
                    <h2 className="text-lg font-bold text-slate-800 flex items-center gap-2">
                        <TickCircle size="24" color="#4f46e5" />
                        Venue Tasks
                    </h2>
                    <p className="text-slate-500 text-sm">Manage maintenance and operational tasks for this venue</p>
                </div>
                <button
                    onClick={() => {
                    ...
                    className="flex items-center space-x-2 px-4 py-2 bg-primary-600 text-white rounded-lg hover:bg-primary-700 transition-colors shadow-md shadow-primary-200"
                >
